                  ...
                  <FormGroup row>
                    ...
                    <Col md="9">
                      <FormGroup check inline>
                        <Input className="form-check-input" type="radio" id="inline-radio4" name="inline-radios2" value="option1" />
                        <Label className="form-check-label" check htmlFor="inline-radio4">One</Label>
                      </FormGroup>
                      <FormGroup check inline>
                        <Input className="form-check-input" type="radio" id="inline-radio5" name="inline-radios2" value="option2" />
                        <Label className="form-check-label" check htmlFor="inline-radio5">Two</Label>
                      </FormGroup>
                      <FormGroup check inline>
                        <Input className="form-check-input" type="radio" id="inline-radio6" name="inline-radios2" value="option3" />
                        <Label className="form-check-label" check htmlFor="inline-radio6">Three</Label>
                      </FormGroup>
                    </Col>
                  </FormGroup>
                  <FormGroup row>
                    ...
                    <Col md="12">
                      <InputGroup>
                        ...
                        <InputGroupButtonDropdown addonType="append"
                          ...
                          <DropdownMenu className={this.state.second ? 'show' : ''} right>
                            <DropdownItem>Action</DropdownItem>
                            <DropdownItem>Another Action</DropdownItem>
                            <DropdownItem>Something else here</DropdownItem>
                            <DropdownItem divider />
                    ...
                    <Col md="12">
                      <InputGroup>
                        ...
                        <InputGroupButtonDropdown  addonType="append"
                          ...
                          <DropdownMenu className={this.state.fourth ? 'show' : ''} right>
                            <DropdownItem>Action</DropdownItem>
                            <DropdownItem>Another Action</DropdownItem>
                            <DropdownItem>Something else here</DropdownItem>
                            <DropdownItem divider />
